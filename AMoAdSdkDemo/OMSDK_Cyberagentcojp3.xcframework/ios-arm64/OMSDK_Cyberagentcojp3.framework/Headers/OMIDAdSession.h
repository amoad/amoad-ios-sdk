 ...
 */
@interface OMIDCyberagentcojp3AdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDCyberagentcojp3AdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDCyberagentcojp3AdSessionConfiguration *)configuration
                              adSessionContext:(OMIDCyberagentcojp3AdSessionContext *)context
