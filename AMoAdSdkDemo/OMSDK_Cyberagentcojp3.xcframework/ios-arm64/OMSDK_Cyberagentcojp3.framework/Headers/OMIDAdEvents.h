 ...
 */
@interface OMIDCyberagentcojp3AdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDCyberagentcojp3AdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDCyberagentcojp3VASTProperties *_Nonnull)vastProperties
