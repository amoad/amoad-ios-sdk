...
- (void)viewDidLoad {
  ...
  // [SDK] プリロール広告を描画する
  [AMoAdNativePreRoll renderAdWithSid:kSid tag:kTag view:self.view analytics:analytics isFullscreenClickable: false completion:^(NSString *sid, NSString *tag, UIView *view, AMoAdResult state) {
    switch (state) {
