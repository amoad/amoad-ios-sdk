//
//  IconTextLinkViewController.m
//  AMoAdSdkDemo
//
//  Created by AMoAd on 2015/02/24.
//  Copyright (c) 2015年 AMoAd, Inc. All rights reserved.
//
#import "IconTextLinkViewController.h"
...
@interface IconTextLinkViewController () <AMoAdNativeAppDelegate>
@property (weak, nonatomic) IBOutlet UIView *renderAdView;
@end

@implementation IconTextLinkViewController
...
- (void)viewDidLoad {
  ...
  [adView setFrame:CGRectMake(0, 220, 320, 100)];
