...
@interface TableViewIconTextViewController () <UITableViewDataSource, UITableViewDelegate, AMoAdNativeListViewDelegate>
...
@implementation TableViewIconTextViewController
