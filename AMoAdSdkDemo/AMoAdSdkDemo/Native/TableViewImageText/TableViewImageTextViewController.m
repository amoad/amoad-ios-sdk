...
static NSString *const kNibName = @"AdImageTextTableViewCell";
...
@interface TableViewImageTextViewController () <UITableViewDataSource, UITableViewDelegate, AMoAdNativeListViewDelegate>
...
@implementation TableViewImageTextViewController
