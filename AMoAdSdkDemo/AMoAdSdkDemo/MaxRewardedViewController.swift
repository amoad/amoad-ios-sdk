//
//  MaxRewardedViewController.swift
//  AMoAdSdkDemo
//
//  Created by 中村 正義 on 2025/02/26.
...
class MaxRewardedViewController: UIViewController {
...
extension MaxRewardedViewController: MARewardedAdDelegate {
