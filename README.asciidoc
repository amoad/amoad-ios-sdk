= AMoAd SDK Guide for iOS

:numbered:
:sectnums:

- link:https://github.com/amoad/amoad-ios-sdk/releases[最新版をダウンロード]
- link:https://github.com/amoad/amoad-ios-sdk/releases/latest[安定版をダウンロード]
