...
** [NEW] ネイティブ広告デリゲートを追加しました（詳しくは、link:Documents/Native/Overview_nativeApp.asciidoc#-12[ネイティブ（App）] / link:Documents/Native/Overview_nativeApp.asciidoc#-13[リストビュー]）。
